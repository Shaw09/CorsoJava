...
public class Automobile extends Prodotto {
	...
	/**
	 * Questo metodo stampa le caratteristiche di una automobile
	 * Per maggiori informazioni vedere anche il metodo stampaProdotto() della classe Prodotto
	 * 
	 * @see it.corso.java.oop.gestionale.Prodotto#stampaProdotto()
	 */
	@Override
