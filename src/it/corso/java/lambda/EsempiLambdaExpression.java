...
public class EsempiLambdaExpression {
	public static void main(String[] args) {
		Thread t1 = new Thread(){
			@Override
			public void run(){
				System.out.println("Ecco un thread creato senza Lambda Expression");
			}
		};
		
		Thread t2 = new Thread(() -> System.out.println("Questo è un thread creato usando le Lambda Expression...!"));
