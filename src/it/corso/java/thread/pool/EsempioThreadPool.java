...
public class EsempioThreadPool {
	public static void main(String[] args) {
		...
		threadpool.execute(new GetSitePage("http://www.google.it"));
		
		/* spengo il thread pool */
		threadpool.shutdown();
		
		/*
		 * se provate ad aggiungere un nuovo thread dopo aver invocato il metodo shutdown riceverete la seguente eccezione
		 * 
		 * Exception in thread "main" java.util.concurrent.RejectedExecutionException: Task Thread[Thread-2,5,main] rejected
		 * at java.util.concurrent.ThreadPoolExecutor$AbortPolicy.rejectedExecution(ThreadPoolExecutor.java:2047)
		 * at java.util.concurrent.ThreadPoolExecutor.reject(ThreadPoolExecutor.java:823)
		 * at java.util.concurrent.ThreadPoolExecutor.execute(ThreadPoolExecutor.java:1369)
		 * it.preite.pool.EsempioThreadPool.main(EsempioThreadPool.java:18)
		 * 
